...
app.use('/trade-instruction/swagger', express.static('./public/swagger-ui'));
var router = express.Router();
app.get('/trade-instruction/swaggerjson', function (req, res) {
...
app.use(expressJWT({
	...
	path: ['/users','/trade-instruction/swaggerjson','/trade-instruction/swagger']
}));
app.use(bearerToken());
